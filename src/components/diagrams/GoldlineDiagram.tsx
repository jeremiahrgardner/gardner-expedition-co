...
export default function GoldlineDiagram({
  ...
  return (
    ...
    >
      {/* Cave walls */}
      <path d={topWall} fill="#111111" opacity="0.06" />
      <path d={bottomWall} fill="#111111" opacity="0.06" />

      {/* Wall outlines — stroke only */}
      <path d={topWall} fill="none" stroke="#111111" strokeWidth="0.8" opacity="0.3" />
      <path d={bottomWall} fill="none" stroke="#111111" strokeWidth="0.8" opacity="0.3" />
      ...
      {[160, 220, 280, 340, 400, 460].map((x, i) => (
        <line key={i} x1={x} y1={136} x2={x} y2={144}
              stroke="#B89B5E" strokeWidth="0.6" opacity="0.5" />
      ))}

      {/* Visibility cone — what the diver can see */}
      <path d={visibilityLeft} fill="#111111" opacity={hovered ? "0.08" : "0.04"}
            style={{ transition: 'opacity 0.8s ease' }} />
      <path d={visibilityRight} fill="#111111" opacity={hovered ? "0.08" : "0.04"}
            style={{ transition: 'opacity 0.8s ease' }} />

      {/* Diver indicator — small dot at starting point */}
      <circle cx="80" cy="140" r="4" fill="none" stroke="#111111" strokeWidth="0.8" opacity="0.4" />
      <circle cx="80" cy="140" r="1.5" fill="#111111" opacity="0.4" />

      {/* Annotation: Entry */}
      <text x="76" y="158" fontSize="7" fontFamily="Inter, sans-serif"
            letterSpacing="0.1em" fill="#111111" opacity="0.4" textAnchor="middle"
            fontStyle="italic">
        entry
      </text>
      ...
      <text x="440" y="126" fontSize="7" fontFamily="Inter, sans-serif"
            letterSpacing="0.1em" fill="#B89B5E" opacity="0.6" textAnchor="middle"
            fontStyle="italic">
      ...
      <text x="300" y="132" fontSize="7.5" fontFamily="Inter, sans-serif"
            letterSpacing="0.14em" fill="#B89B5E" opacity="0.8" textAnchor="middle"
            fontWeight="500">
        GOLDLINE
      </text>
      ...
      {[60, 120, 200, 280, 360, 440].map((x, i) => (
        <text key={i} x={x} y="270" fontSize="6.5" fontFamily="Inter, sans-serif"
              letterSpacing="0.08em" fill="#111111" opacity="0.3" textAnchor="middle">
          {`${10 + i * 8}m`}
        </text>
      ))}
      ...
      <text x={width / 2} y="18" fontSize="7.5" fontFamily="Inter, sans-serif"
            letterSpacing="0.2em" fill="#111111" opacity="0.4" textAnchor="middle"
            fontWeight="500">
