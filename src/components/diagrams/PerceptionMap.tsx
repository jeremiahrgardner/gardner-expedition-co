  ...
  return (
    ...
    >
      ...
      <rect x="20" y="44" width="190" height="220"
            fill="none" stroke="#0A0A0A" strokeWidth="0.7" opacity="0.25"
            strokeDasharray="4 3" />
      ...
      {[ 55, 90, 72, 108, 63, 95, 82, 118, 70, 100, 88, 76, 110, 65, 98, 84, 112, 74, 102, 92 ].map((y, i) => (
        <circle key={i} cx={35 + (i % 5) * 22} cy={68 + Math.floor(i / 5) * 32}
                r="2.5" fill="#0A0A0A" opacity="0.35" />
      ))}

      {/* Label */}
      <text x="28" y="28" fontSize="8" fontFamily="Inter, sans-serif"
            letterSpacing="0.18em" fill="#0A0A0A" opacity="0.5" fontWeight="500">
        THE OBSERVED
      </text>
      ...
      {[0, 1, 2, 3, 4].map(i => (
        <path
          ...
          fill="none" stroke="#F1C233" strokeWidth="0.6" opacity="0.5"
      ...
      <text x="218" y={height / 2 + 4} fontSize="7" fontFamily="Inter, sans-serif"
            letterSpacing="0.12em" fill="#F1C233" opacity="0.6" textAnchor="middle"
            fontStyle="italic">
        distortion
      </text>
      ...
      <path d="M 210 158 L 264 158" stroke="#0A0A0A" strokeWidth="0.8" opacity="0.4"
            markerEnd="url(#arrowhead)" />
      <defs>
        <marker id="arrowhead" markerWidth="6" markerHeight="4" refX="6" refY="2" orient="auto">
          <polygon points="0 0, 6 2, 0 4" fill="#0A0A0A" opacity="0.4" />
        </marker>
      </defs>

      {/* Bottom annotation */}
      <text x={width / 2} y="288" fontSize="7" fontFamily="Inter, sans-serif"
            letterSpacing="0.1em" fill="#0A0A0A" opacity="0.35" textAnchor="middle"
            fontStyle="italic">
        — perception constructs the grid —
      </text>

      {/* Corner tick marks */}
      <path d="M 20 44 L 20 54 M 20 44 L 30 44" stroke="#0A0A0A" strokeWidth="0.6" opacity="0.3" fill="none" />
      <path d={`M ${width - 20} 44 L ${width - 20} 54 M ${width - 20} 44 L ${width - 30} 44`}
            stroke="#0A0A0A" strokeWidth="0.6" opacity="0.3" fill="none" />
